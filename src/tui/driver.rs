...
//! implementation is [`crate::tui::pty::PtsPty`] over `portable-pty`; tests
//! use an in-memory one — the driver is generic over the seam, which is
//! what keeps it testable without a real terminal.
//!
...
use crate::tui::scrollback::{Decode, append_to_buffer};
