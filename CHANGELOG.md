...
## [0.11.0](https://github.com/mnzsss/ivar/compare/v0.10.0...v0.11.0) - 2026-09-18
...
- add codebase graph ([#92](https://github.com/mnzsss/ivar/pull/92))
- *(repo)* Add repository creation ([#96](https://github.com/mnzsss/ivar/pull/96))
...
- move working documents into the feature directory ([#81](https://github.com/mnzsss/ivar/pull/81))
- open the generated workspace in the editor ([#80](https://github.com/mnzsss/ivar/pull/80))
- complete feature names in OMP and generate multi-root workspaces ([#79](https://github.com/mnzsss/ivar/pull/79))
...
- *(test)* Wait for editor marker file to have content ([#82](https://github.com/mnzsss/ivar/pull/82))
...
- *(hall)* append 'For AI Agents' directive block to HALL.md ([#48](https://github.com/mnzsss/ivar/pull/48))

## [0.6.1](https://github.com/mnzsss/ivar/compare/v0.6.0...v0.6.1) - 2026-08-27

### Fixed

- *(harness)* Consume $ARGUMENTS in every command that declares one ([#46](https://github.com/mnzsss/ivar/pull/46))

## [0.6.0](https://github.com/mnzsss/ivar/compare/v0.5.0...v0.6.0) - 2026-08-26

### Changed

- *(mcp)* [**breaking**] hall-qualified MCP server names at every provider boundary ([#44](https://github.com/mnzsss/ivar/pull/44))

## [0.5.0](https://github.com/mnzsss/ivar/compare/v0.4.0...v0.5.0) - 2026-08-26

### Added

- *(mcp)* authenticate the hall's declared MCP servers per name ([#43](https://github.com/mnzsss/ivar/pull/43))
- *(harness)* Review a feature or pull request on two axes ([#40](https://github.com/mnzsss/ivar/pull/40))

### Fixed

- *(harness)* Stop the review when the harness has no subagent ([#41](https://github.com/mnzsss/ivar/pull/41))
